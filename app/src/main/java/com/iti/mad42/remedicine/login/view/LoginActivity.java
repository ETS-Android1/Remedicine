...
import com.iti.mad42.remedicine.login.presenter.LoginPresenter;
import com.iti.mad42.remedicine.login.presenter.LoginPresenterInterface;
...
public class LoginActivity extends AppCompatActivity implements LoginActivityInterface {
    ...
    public void navigateToHome() {
        intent = new Intent(LoginActivity.this, BottomNavigationBar.class);
        startActivity(intent);
        finish();
    }
